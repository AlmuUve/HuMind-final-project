		...
		<Fragment>
			...
			<div className="landingDescription container-fluid row">
				...
				<div className="description col-md-7 col-xs-12">
					...
					<p>
						We want to promote <span className="blueSpan">training from within companies</span> that leads
						to improvement in the well-being of their employees that is reflected both personally and at
						work.
					</p>
				</div>
			</div>
			<div className="iAmAcompany container-fluid row">
				...
				<div className="iAmAcompany3 col-md-4 col-xs-12">
					...
					<p className="iAmAcompanyText2">
						<span className="blueSpan">+</span> Would you like to offer social benefits that give added
						value?
					</p>
				</div>
			</div>
