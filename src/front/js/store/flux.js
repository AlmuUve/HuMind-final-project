		...
		actions: {
			getSearchResults: async keyword => {
				let response = await fetch(
					"https://3001-blush-wildcat-cexmd835.ws-eu03.gitpod.io/user/" +
			...
			getAllWorkshops: () => {
				fetch("https://3001-blush-wildcat-cexmd835.ws-eu03.gitpod.io/search_workshop").then(async res => {
			...
			getWorkshops: () => {
				fetch("https://3001-blush-wildcat-cexmd835.ws-eu03.gitpod.io/user/company/1/workshops").then(
					async res => {
						const response = await res.json();
